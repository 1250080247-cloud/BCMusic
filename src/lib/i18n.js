export const dictionaries = {
  vi: {
    ...
    searchPage: {
      ...
      noHistoryHint: 'Hãy thử tìm kiếm một bài hát nào đó nhé!',
      resultsFor: 'Kết quả cho',
      noResults: 'Không tìm thấy kết quả nào',
      noResultsHint: 'Hãy thử với từ khoá khác.',
  ...
  en: {
    ...
    searchPage: {
      title: 'Search',
      placeholder: 'Type a song, artist...',
      button: 'Search',
      recentSearches: 'Recent searches',
      clearAll: 'Clear all',
      noHistory: 'No search history yet',
      noHistoryHint: 'Try searching for a song!',
